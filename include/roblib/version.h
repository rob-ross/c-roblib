...
#define ROBLIB_JSONP_VERSION_PATCH 2

#define ROBLIB_STRING_SLICE_VERSION_MAJOR 0
#define ROBLIB_STRING_SLICE_VERSION_MINOR 1
#define ROBLIB_STRING_SLICE_VERSION_PATCH 0
