...
enum json_error_type {
    JSON_ERR_NONE, JSON_ERR_NULL_TEXT, JSON_ERR_EMPTY_TEXT, JSON_ERR_UNEXPECTED_TEXT, JSON_ERR_UNESCAPED_CONTROL_CHAR,
    JSON_ERR_UNEXPECTED_EOF, JSON_ERR_UNTERMINATED_ARRAY, JSON_ERR_UNTERMINATED_STRING, JSON_ERR_UNTERMINATED_OBJECT,
    JSON_ERR_MISSING_COMMA,
    JSON_ERR_INVALID_UNICODE_ESCAPE, JSON_ERR_NO_PRECEDING_HIGH_SURROGATE, JSON_ERR_NO_FOLLOWING_LOW_SURROGATE,
    JSON_ERR_RESERVED_FOR_HIGH_SURROGATE, JSON_ERR_RESERVED_FOR_LOW_SURROGATE, JSON_ERR_CODEPOINT_OUT_OF_RANGE,
    JSON_ERR_INVALID_UTF8_START_BYTE, JSON_ERR_INVALID_UTF8_CONTINUATION_BYTE, JSON_ERR_OVERLONG_SEQUENCE,
